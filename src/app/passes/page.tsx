...
import { FileText, Utensils, Shirt, Plane, MoreHorizontal, Ticket, ShoppingBasket } from 'lucide-react';
import { Chatbot } from '@/components/scanalyze/chatbot';
import { Skeleton } from '@/components/ui/skeleton';

const categoryConfig: { [key: string]: { icon: JSX.Element; color: string; } } = {
  grocery: { icon: <ShoppingBasket className="h-6 w-6" />, color: "bg-green-500/10 text-green-700 dark:text-green-400" },
  dining: { icon: <Utensils className="h-6 w-6" />, color: "bg-red-500/10 text-red-700 dark:text-red-400" },
